  ...
  return (
    <div className=" w-full max-w-xs">
      ...
      <form onSubmit={handleSubmit} className="mb-4 rounded bg-white px-8 pb-8 pt-6 shadow-md">
        <div className="mb-4">
          <label className="mb-2 block text-sm font-bold text-gray-700">Competition name:</label>
          <input
            type="text"
            value={name}
        ...
        <label className="mb-2 block text-sm font-bold text-gray-700">Goal</label>
         ...
         <label className="mb-2 block text-sm font-bold text-gray-700">Competition type</label>
